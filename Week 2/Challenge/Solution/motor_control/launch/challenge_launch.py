...
def generate_launch_description():
    ...
    group1_description_launch_1 = IncludeLaunchDescription(launch_source1)
    #Include the launch description for group2
    group2_description_launch_2 = IncludeLaunchDescription(launch_source2)
    ...
    group3_description_launch_3= IncludeLaunchDescription(
